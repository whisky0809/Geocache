...
C_SRCS += \
../source/utils/gps/gps.c 

C_DEPS += \
./source/utils/gps/gps.d 

OBJS += \
./source/utils/gps/gps.o 


# Each subdirectory must supply rules for building sources it contributes
source/utils/gps/%.o: ../source/utils/gps/%.c source/utils/gps/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-utils-2f-gps

clean-source-2f-utils-2f-gps:
	-$(RM) ./source/utils/gps/gps.d ./source/utils/gps/gps.o

.PHONY: clean-source-2f-utils-2f-gps
